...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <div class='info-row'>
                <span class='label'>Név:</span> {$safeName}
            </div>
            ...
            <div class='info-row'>
                <span class='label'>Telefon:</span> <a href='tel:{$safePhone}'>{$safePhone}</a>
            </div>
...
if ($mailSent) {
    ...
    $confirmationHeaders .= "From: " . $safeFromEmail . "\r\n";
    $confirmationHeaders .= "Reply-To: " . $safeFromEmail . "\r\n";

    mail($safeEmail, $confirmationSubject, $confirmationBody, $confirmationHeaders);
